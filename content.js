...
// find goalies
fetch("https://statsapi.web.nhl.com/api/v1/schedule").then(s => s.json()).then(d => Promise.all(d.dates[0].games.map(g => fetch(`https://statsapi.web.nhl.com/api/v1/game/${g.gamePk}/boxscore`))))
